...
const Home = () => {
  return (
    <div className="text-center">
      ...
      <p className="text-xl mb-8">Explore our collection of books, authors, and more.</p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <h2 className="text-2xl font-semibold mb-3 text-blue-600">Books</h2>
          <p className="mb-4">Browse our extensive collection of books across various genres.</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          ...
          <p className="mb-4">Discover talented authors and their published works.</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          ...
          <p className="mb-4">Learn about the publishers behind your favorite books.</p>
