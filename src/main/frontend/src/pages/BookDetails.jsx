...
const BookDetails = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-bookstore-lighter to-white p-8 rounded-xl shadow-lg max-w-6xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div className="md:col-span-2">
          <div className="flex justify-between items-start mb-6">
            <h1 className="text-4xl font-bold text-bookstore-dark drop-shadow-sm font-serif">{book.title}</h1>
            {userIsAdmin && (
          ...
          <div className="flex space-x-4 mb-6">
            <button
              ...
              className="bg-bookstore-primary text-white px-6 py-3 rounded-lg hover:bg-bookstore-secondary transition-colors shadow-md flex items-center"
            >
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg mb-8">
        <h2 className="text-2xl font-semibold mb-6 text-gray-700 flex items-center border-b pb-3">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-bookstore-primary" viewBox="0 0 20 20" fill="currentColor">
        ...
        {reviewsLoading ? (
          <div className="flex justify-center items-center p-4">
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-bookstore-primary"></div>
            <p className="ml-2 text-gray-500">Loading reviews...</p>
          </div>
        ) : reviews.length > 0 ? (
          <div className="space-y-6">
            {reviews.map(review => (
              <div key={review.id} className="bg-bookstore-lighter p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <p className="text-gray-700 mb-3 italic">{review.text}</p>
                <div className="flex items-center">
                  <div className="bg-bookstore-primary text-white rounded-full w-8 h-8 flex items-center justify-center mr-2">
      ...
      {userIsAuthenticated ? (
            ...
            <button
              ...
              className={`px-6 py-3 rounded-lg shadow-md flex items-center ${
                reviewSubmitting
                  ...
                  : 'bg-bookstore-primary hover:bg-bookstore-secondary text-white transition-colors'
              }`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="bg-bookstore-lighter p-6 rounded-xl shadow-md mb-8 border border-bookstore-light">
          <div className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-bookstore-primary mr-4" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
            </svg>
            <p className="text-gray-700 font-medium">
              Please <Link to="/sign-in" className="text-bookstore-primary hover:text-bookstore-accent underline">log in</Link> to leave a review.
            </p>
          </div>
        </div>
      )}
      ...
      <Link 
        to="/books" 
        className="inline-flex items-center text-bookstore-primary hover:text-bookstore-accent font-medium transition-colors bg-white px-4 py-2 rounded-lg shadow-sm hover:shadow-md"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
